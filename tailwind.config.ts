  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-emerald-light': 'linear-gradient(135deg, #ecfdf5 0%, #ffffff 100%)',
      },
      animation: {
      ...
      boxShadow: {
        ...
        'emerald-lg': '0 10px 25px 0 rgba(16, 185, 129, 0.3)',
        'emerald-xl': '0 20px 40px 0 rgba(16, 185, 129, 0.35)',
      },
      borderRadius: {
        '4xl': '2rem',
        '5xl': '2.5rem',
